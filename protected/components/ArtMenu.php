 ...
 * ArtMenu class file.
 *
 * @author Byron Lee <artmenu@bglee.myfastmail.com>
 * @link http://www.yiiframework.com/
 * @copyright Copyright &copy; 2011
 * @license http://www.yiiframework.com/license/
 *
 * ArtMenu is a drop in replacement for CMenu with minor changes to support Artisteer 2.4.x based themes.
 * The original version extended the CMenu class from 1.1.4, but was broken by later releases.  
 */

/**
 * ArtMenu (a minor modification of CMenu by Jonah Turnquist and Qiang Xue) displays a multi-level menu using nested HTML lists.
 *
 * The main property of ArtMenu is {@link items}, which specifies the possible items in the menu.
 ...
 *
 * The following example shows how to use ArtMenu:
 * <pre>
...
class ArtMenu extends CWidget
{
	 ...
	 * Defaults to null, meaning no wrapper tag will be generated.  (REMOVED!)
	 * @since 1.1.4
	 */
	...
	public $lastItemCssClass;
        ...
        /**
         * Variables added to support Artisteer Menus
         */
        
        /**
         * @var string the CSS class applied to the ul tag to support Artisteer menus.
         * Defaults to null, which means that technically ArtMenu can be used for non Artisteer menus.
         */
        public $cls;

        /**
         * @var string the HTML markup that is prepended to the link label.
         * Unlike $linkLabelWrapper (removed from this version), $prelinklabel can be multiple tags.
         * Example: $prelinklabel='<span class="l"></span><span class="r"></span><span class="t">';
         */
        public $prelinklabel;

        /**
         * @var string the HTML markup that is appended to the link label.
         * Unlike $linkLabelWrapper (removed from this version), $postlinklabel can be multiple tags.
         * Example: $postlinklabel='</span>';
         */
        public $postlinklabel;
	 ...
	 */
        public function init()
        {
                if (isset($this->cls))
                {
                        $this->htmlOptions['class']=$this->cls;
                }
	...
	protected function renderMenuItem($item)
	{
		if(isset($item['url']))
		{
                        // customization added by B. Lee 4/17/2011
                        //$label='<span class="l"></span><span class="r"></span><span class="t">'.$item['label'].'</span>';
